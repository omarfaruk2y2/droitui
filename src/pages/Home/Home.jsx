...
const Home = () => {
  return (
    <>
      <Helmet>
        <title>Droit UI - The Next Gen Figma Design System</title>
            ...
            <div class="ui-ideal-block">
              ...
              <div class="ui-ideal-item-block">
                ...
                <FadeUpOnView delay={0.3}>
                  <div class="ui-ideal-item">
                    <FadeUpOnView delay={0.3}>
                      <img src="https://cdn.prod.website-files.com/652a94d2422fddacbf881a46/65d1ffb2960ab49fbb9fc645_Icon%20(5).svg" loading="lazy" alt="" />
                    </FadeUpOnView>
                    <FadeUpOnView delay={0.3}>
                ...
                <FadeUpOnView delay={0.3}>
                  <div class="ui-ideal-item">
                    <FadeUpOnView delay={0.3}>
                      <img src="https://cdn.prod.website-files.com/652a94d2422fddacbf881a46/65d1ffb1d9336e770ec577dc_Icon%20(6).svg" loading="lazy" alt="" />
                    </FadeUpOnView>
                    <FadeUpOnView delay={0.3}>
